...
public class QRScanner {
	...
	public String takeInstantSnap(boolean turnOnPreview) throws FailedToRunRaspistillException {
		RPiCamera piCamera = new RPiCamera("./").setTimeout(50).turnOffThumbnail();
		if(turnOnPreview == false) {
